...
@interface XYDynaSearchSelectionField : XYAdvField
...
/**
 Array list of selection items
 XYLabelValue objects
 */
...
/**
 ...
 Could be:
 1) XYLabelValue array
 2) NSString array, key and value will be same
 */
